...
if __name__ == "__main__":
    ...
    raw_bucket = os.getenv("S3_BUCKET_NAME", "yahoo-finance-stock")  # Raw data S3 bucket
    transformed_bucket = os.getenv("S3_BUCKET_NAME", "yahoo-finance-stock")  # Transformed data S3 bucket
    raw_prefix = os.getenv("RAW_PREFIX", "raw_data/")  # Prefix for raw data in S3
    transformed_prefix = os.getenv("TRANSFORMED_PREFIX", "transformed_data/")  # Prefix for transformed data in S3
